...
@app.route('/')
def home():
	return render_template('index1main.html', title='CodeMonks-SAVE THE WORLD')

@app.route('/rainwater')
def homeRainwater():
	return render_template('index.html', title='CodeMonks-RainwaterHarvest')

@app.route('/solar')
def homeSolar():
	return render_template('solar.html', title='CodeMonks-Solar Potential')
